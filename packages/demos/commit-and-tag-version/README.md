...
**GitHub Repository**: [absolute-version/commit-and-tag-version](https://github.com/absolute-version/commit-and-tag-version)
...
- ✅ **Volle Kontrolle** - ggf. explizite npm scripts für jeden Release-Type
...
- [commit-and-tag-version GitHub](https://github.com/absolute-version/commit-and-tag-version)
